...
class VetGalleryManagementPage extends StatefulWidget {
  ...
  const VetGalleryManagementPage({super.key, required this.businessId});
...
class _VetGalleryManagementPageState extends State<VetGalleryManagementPage> {
  ...
  DocumentReference<Map<String, dynamic>> get _businessRef => FirebaseFirestore
      .instance
  ...
  Stream<List<String>> _galleryStream() {
    return _businessRef.snapshots().map((snapshot) {
      ...
      final profileContent =
          (veterinary['profileContent'] as Map<String, dynamic>?) ?? {};
      _coverImageUrl = profileContent['coverImageUrl']?.toString();
      final raw = profileContent['clinicPhotoUrls'];
  ...
  Future<void> _addPhoto() async {
    try {
      ...
      profileContent['clinicPhotoUrls'] = current;

      veterinary['profileContent'] = profileContent;

      sectorData['veterinary'] = veterinary;

      await _businessRef.update({'sectorData': sectorData});
  ...
  Future<void> _reorderPhotos(
    ...
    try {
      ...
      profileContent['clinicPhotoUrls'] = updated;
  ...
  Future<void> _changeCoverImage() async {
    try {
      ...
      profileContent['coverImageUrl'] = url;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text(_loading ? 'Uploading...' : 'Add Photo'),
      ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: _loading ? null : _changeCoverImage,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: AppTheme.body(color: Colors.grey.shade600),
                            ),
                  ...
                  Expanded(
                    child: ReorderableListView.builder(
                      ...
                      onReorder: (oldIndex, newIndex) =>
                          _reorderPhotos(oldIndex, newIndex, images),
