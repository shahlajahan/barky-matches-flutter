...
final String? shippingMode; // carrier_calculated | fixed_price | free_shipping | seller_absorbs
  ...
  factory Product.fromJson(String id, Map<String, dynamic> json) {
    ...
    if (mediaList != null) {
      parsedMedia = (mediaList as List<dynamic>)
          .map((e) =>
              ProductMedia.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList();
    } else {
      // 🔥 fallback قدیمی
...
finalRecommendedPrice:
    (json["finalRecommendedPrice"] as num?)?.toDouble(),
...
hasContractedReturnCarrier:
    json['hasContractedReturnCarrier'] ?? false,
