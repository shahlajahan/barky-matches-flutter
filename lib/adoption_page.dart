    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return Center(child: Text(l10n.noAdoptionCentersAvailable));
        }
  ...
  Widget _buildDogsSection() {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return Center(child: Text(l10n.noDogsAvailableForAdoption));
        }
...
class _AdoptionOwnerOverlay extends StatelessWidget {
  ...
  const _AdoptionOwnerOverlay({required this.ownerId, required this.onClose});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        final dogs =
            snapshot.data?.docs.map((doc) => Dog.fromFirestore(doc)).toList() ??
            [];
      ...
      builder: (context) {
        return Padding(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(l10n.adoptionRequestTitle, style: AppTheme.h2()),
              const SizedBox(height: 16),
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(l10n.adoptionRequestSent(dog.name)),
                      ),
                    );
                  },
...
class _AdoptionDogOverlay extends StatelessWidget {
  ...
  const _AdoptionDogOverlay({required this.dog});
              ...
              child: Column(
                ...
                children: [
                  ...
                  DogCard(
                    ...
                    currentUserId: appState.currentUserId ?? '',
                    favoriteDogs: appState.favoriteDogs,
                    onToggleFavorite: (d) => appState.toggleFavorite(d),
                    likers: appState.dogLikes[dog.id] ?? [],
                    enableEdit: false,
                  ),
...
class _CenterDogsSubPage extends StatelessWidget {
  ...
  const _CenterDogsSubPage({required this.centerId});
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (dogs.isEmpty) {
                  return Center(child: Text(l10n.noDogsAvailableInThisCenter));
                }
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: DogCard(
                        ...
                        enablePlaydate: false,
                        onCardTap: () {
                          context.read<AppState>().openAdoptionDogOverlay(
                            dog.id,
                          );
                        },
                      ),
