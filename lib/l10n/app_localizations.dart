...
abstract class AppLocalizations {
  ...
  /// No description provided for @skuLockedAfterCreation.
  ///
  /// In en, this message translates to:
  /// **'SKU cannot be changed after a listing is created. To use a different SKU, delete this listing and create a new one.'**
  String get skuLockedAfterCreation;
  ...
  /// No description provided for @deleteProductConfirmAction.
  ///
  /// In en, this message translates to:
  /// **'Delete'**
  String get deleteProductConfirmAction;

  /// No description provided for @deleteProductCancelAction.
  ///
  /// In en, this message translates to:
  /// **'Cancel'**
  String get deleteProductCancelAction;

  /// No description provided for @deleteProductInProgress.
  ///
  /// In en, this message translates to:
  /// **'Deleting…'**
  String get deleteProductInProgress;

  /// No description provided for @deleteProductSuccess.
  ///
  /// In en, this message translates to:
  /// **'Product deleted'**
  String get deleteProductSuccess;

  /// No description provided for @deleteProductAlreadyGone.
  ///
  /// In en, this message translates to:
  /// **'This listing no longer exists'**
  String get deleteProductAlreadyGone;

  /// No description provided for @deleteProductPermissionDenied.
  ///
  /// In en, this message translates to:
  /// **'You don\'t have permission to delete this product'**
  String get deleteProductPermissionDenied;

  /// No description provided for @deleteProductNetworkError.
  ///
  /// In en, this message translates to:
  /// **'Couldn\'t delete the product. Check your connection and try again.'**
  String get deleteProductNetworkError;
