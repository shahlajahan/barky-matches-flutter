...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get userProfileUpgradeBusinessDescription =>
      'Перейдите на Gold, чтобы зарегистрировать бизнес и начать получать клиентов.';
  ...
  String get userProfileUpgradeToGoldToContinue =>
      'Перейдите на Gold, чтобы продолжить';
  ...
  String get goldPlanSubtitle =>
      'Для бизнесов в сфере питомцев и опытных пользователей';
