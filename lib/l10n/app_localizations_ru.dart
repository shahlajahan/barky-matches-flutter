...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get skuLockedAfterCreation => 'После создания объявления SKU изменить нельзя. Чтобы использовать другой SKU, удалите это объявление и создайте новое.';

  @override
  String get deleteProductConfirmTitle => 'Удалить этот товар?';

  @override
  String get deleteProductConfirmMessage => 'Товар будет удалён без возможности восстановления.';

  @override
  String get deleteProductConfirmAction => 'Удалить';

  @override
  String get deleteProductCancelAction => 'Отмена';

  @override
  String get deleteProductInProgress => 'Удаление…';

  @override
  String get deleteProductSuccess => 'Товар удалён';

  @override
  String get deleteProductAlreadyGone => 'Это объявление больше не существует';

  @override
  String get deleteProductPermissionDenied => 'У вас нет прав на удаление этого товара';

  @override
  String get deleteProductNetworkError => 'Не удалось удалить товар. Проверьте подключение и попробуйте снова.';
