...
enum ProductCardMode { dashboard, customerList }
...
class ProductCardShared extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final discountAmount = hasDiscount
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(LucideIcons.package, size: 14, color: AppTheme.muted),
  ...
  void _buyNow(BuildContext context) {
    ...
    debugPrint(
      "🔴 BUY NOW CART ITEM carriers: ${cartItem.allowedCarrierCodes}",
    );
