    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          /// message thread
          Expanded(child: _ComplaintMessages(complaintId: complaint.id)),

          /// admin actions
          _AdminActions(complaintId: complaint.id),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(complaint.description, style: const TextStyle(fontSize: 15)),
...
class _ComplaintMessages extends StatelessWidget {
  ...
  const _ComplaintMessages({required this.complaintId});
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(title: Text(text), subtitle: Text(senderType));
          },
        );
      },
    );
...
class _AdminActions extends StatelessWidget {
  ...
  const _AdminActions({required this.complaintId});
