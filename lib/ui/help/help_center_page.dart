...
class HelpCenterPage extends StatelessWidget {
  ...
  Future<void> _openEmail() async {
    final uri = Uri.parse(
      'mailto:info@petsupo.com?subject=PetSupo Support',
    );
  ...
  title: "Visit Website",
  subtitle:
      "Open the official PetSupo website.",

  onTap: () {
    _openUrl(
      "https://www.petsupo.com",
    );
  },
),
              ...
              _buildCard(
                ...
                title: "Instagram",
                subtitle:
                    "Follow PetSupo for updates and news.",

                onTap: () {
                 _openUrl(
  "https://instagram.com/petsupo.app",
);
                },
              ),
