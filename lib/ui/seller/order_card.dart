...
class SellerOrderCard extends StatelessWidget {
  ...
  Future<void> updateStatus(BuildContext context, String status) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            l10n.orderStatusUpdated(orderStatusLabel(status, l10n)),
          ),
        ),
      );
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    final payoutAmount = payout['amount'] ?? financial['sellerNetAmount'] ?? 0;
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Icon(LucideIcons.package, color: color, size: 20),
                    ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        l10n.buyerNameLabel(billingName),
                        style: const TextStyle(fontSize: 12),
                      ),
                      Text(
                        l10n.buyerSurnameLabel(billingSurname),
                        style: const TextStyle(fontSize: 12),
                      ),
                      Text(
                        l10n.buyerIdentityNumberLabel(billingId),
                        style: const TextStyle(fontSize: 12),
                      ),
                    ],
                  ),
