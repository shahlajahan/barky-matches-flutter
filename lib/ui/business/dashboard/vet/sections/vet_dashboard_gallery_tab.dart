...
class VetDashboardGalleryTab extends StatefulWidget {
  final String businessId;

  const VetDashboardGalleryTab({
    super.key,
    required this.businessId,
  });

  @override
  State<VetDashboardGalleryTab> createState() => _VetDashboardGalleryTabState();
}

class _VetDashboardGalleryTabState extends State<VetDashboardGalleryTab> {
...
await FirebaseFirestore.instance
  ...
  List<String> _mergedImagesFromData(Map<String, dynamic> data) {
    return [
      ...
      ...List<String>.from(data['clinicPhotoUrls'] ?? []),
    ].toSet().toList();
  }
...
final isVideo = _isVideo(url);
                        ...
                        return _GalleryCard(
  imageUrl: url,
  isCover: !isVideo && url == coverImageUrl,
  isVideo: isVideo,
