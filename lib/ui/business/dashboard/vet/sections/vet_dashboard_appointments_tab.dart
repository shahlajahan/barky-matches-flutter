...
_docs = snap.data!.docs;
  ...
  /// ACTION BUILDER
  /// =========================
  Widget _buildActions(DocumentSnapshot doc, String status) {
    if (status == 'pending') {
      return Wrap(
        spacing: 8,
        children: [
          _action(doc, 'confirmed', 'Approve'),
  ...
  return Wrap(
    ...
    children: [
      ...
      _action(doc, 'cancelled_by_vet', 'Cancel'),
    ],
  );
}
  ...
  /// ACTION BUTTON
  /// =========================
  Widget _action(DocumentSnapshot doc, String newStatus, String label) {
