...
class PetHotelReviewsTab extends StatefulWidget {
  ...
  const PetHotelReviewsTab({super.key, required this.businessId});

  @override
  State<PetHotelReviewsTab> createState() => _PetHotelReviewsTabState();
}

class _PetHotelReviewsTabState extends State<PetHotelReviewsTab> {
    ...
    try {
      ...
      if (text.isEmpty) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(l10n.pleaseWriteSomething)));
      ...
      if (existing.docs.isNotEmpty) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(l10n.alreadyReviewedThisVet)));
