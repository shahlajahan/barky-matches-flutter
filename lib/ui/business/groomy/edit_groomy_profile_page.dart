...
class EditGroomyProfilePage extends StatefulWidget {
  ...
  const EditGroomyProfilePage({super.key, required this.businessId});

  @override
  State<EditGroomyProfilePage> createState() => _EditGroomyProfilePageState();
}

class _EditGroomyProfilePageState extends State<EditGroomyProfilePage> {
  ...
  Future<void> _loadBusiness() async {
    try {
      ...
      final groomyData = (sectorData['groomy'] as Map<String, dynamic>?) ?? {};

      final groomyProfile =
          (groomyData['profile'] as Map<String, dynamic>?) ?? {};
...
_instagramController.text =
    (socialMedia['instagram'] ??
      ...
      _workingHoursController.text = (groomyData['workingHours'] ?? '')
          .toString();
    } catch (e) {
      if (!mounted) return;
